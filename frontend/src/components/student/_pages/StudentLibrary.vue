  ...
  <div class="elibrary-wrapper">
    ...
    <div class="hero-header">
      <div class="hero-content">
        ...
        <div>
          <h1 class="title">{{ t('libraryPage.title') }}</h1>
          <p class="subtitle">{{ t('libraryPage.subtitle') }}</p>
        </div>
      </div>
      <div class="stats-badges">
        <div class="stat-badge">
          <span class="stat-number">{{ books.length }}</span>
          <span class="stat-text">{{ t('libraryPage.totalBooks') }}</span>
        </div>
        <div class="stat-badge">
          <span class="stat-number">{{ categories.length > 1 ? categories.length - 1 : 0 }}</span>
          <span class="stat-text">{{ t('libraryPage.categories') }}</span>
        </div>
      </div>
    </div>
    ...
    <div class="category-section">
      <span class="category-label">{{ t('libraryPage.categoriesLabel') }}:</span>
      <div class="category-pills">
        ...
        >
          ...
          <!-- Engineering -->
          <svg v-else-if="cat === 'ENGINEERING'" class="pill-icon" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
          ...
          <!-- Arts -->
          <svg v-else-if="cat === 'ARTS'" class="pill-icon" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
          ...
          <!-- Business -->
          <svg v-else-if="cat === 'BUSINESS'" class="pill-icon" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
          ...
          <!-- Medicine -->
          <svg v-else-if="cat === 'MEDICINE'" class="pill-icon" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            <path d="M22 12h-4l-3 9L9 3l-3 9H2"></path>
          </svg>
          <!-- Law -->
          <svg v-else-if="cat === 'LAW'" class="pill-icon" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            <circle cx="12" cy="12" r="10"></circle>
            <line x1="2" y1="12" x2="22" y2="12"></line>
            <path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"></path>
          </svg>
          <!-- Education -->
          <svg v-else-if="cat === 'EDUCATION'" class="pill-icon" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
    ...
    <div v-if="!isLoading && !error" class="results-info">
      <span>{{ t('libraryPage.showing') }} <strong>{{ filteredBooks.length }}</strong> {{ t('libraryPage.of') }} {{ books.length }} {{ t('libraryPage.books') }}</span>
    </div>
    ...
    <div v-else-if="error" class="error-state">
      ...
      <h3>{{ t('libraryPage.errorTitle') }}</h3>
      <p>{{ error }}</p>
      ...
      >
        <div class="book-cover">
          ...
          <div class="book-overlay">
            <span class="view-btn">{{ t('libraryPage.viewDetails') }}</span>
          </div>
        </div>
        <div class="book-info">
          ...
          <div class="book-meta">
            ...
            <span v-if="book.pages" class="meta-item">
              ...
              {{ book.pages }} {{ t('libraryPage.pages') }}
            </span>
    ...
    <div v-else-if="filteredBooks.length > 0 && viewMode === 'list'" class="books-list">
      ...
      >
        ...
        <div class="list-info">
          ...
          <p class="list-author">{{ t('libraryPage.by') }} {{ book.author || 'Unknown Author' }}</p>
    ...
    <div v-else class="empty-state">
      ...
      <h3>{{ t('libraryPage.noBooksFound') }}</h3>
      <p>{{ t('libraryPage.tryAdjusting') }}</p>
      <button @click="resetFilters" class="btn-reset">
        {{ t('libraryPage.clearFilters') }}
      </button>
    </div>
          ...
          <div class="modal-body">
            ...
            <div class="modal-info">
              ...
              <div class="modal-stats">
                <div class="modal-stat">
                  ...
                  <div>
                    ...
                    <span class="stat-label">{{ t('libraryPage.year') }}</span>
                  </div>
                </div>
                <div class="modal-stat">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                  ...
                  <div>
                    ...
                    <span class="stat-label">{{ t('libraryPage.pages') }}</span>
                  </div>
                </div>
              </div>
              ...
              <div v-if="selectedBook.isbn" class="modal-isbn">
                <span class="isbn-label">{{ t('libraryPage.isbn') }}:</span>
                <span class="isbn-value">{{ selectedBook.isbn }}</span>
              </div>

              <div class="modal-description">
                <h4>{{ t('libraryPage.aboutThisBook') }}</h4>
                <p>{{ selectedBook.description || t('libraryPage.noDescription') }}</p>
              </div>
            </div>
          </div>
        </div>
...
const fetchBooks = async () => {
  ...
  try {
    ...
    error.value = t('libraryPage.fetchError') || 'Failed to load books. Please try again.'
  } finally {
